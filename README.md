...
- Node.js 18.x 이상
- npm 또는 yarn
- [logos_api](https://github.com/maior/logosai-api) 서버 실행 중 (port 8090)
- ACP 서버 실행 중 (port 8888) — [logosai-framework](https://github.com/maior/logosai-framework)의 `SimpleACPServer` 또는 `samples/sample_acp_server.py` 사용
